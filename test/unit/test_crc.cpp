...
{
    TCRCChecksum initial = 'a';
    TCRCChecksum current = 'b';
    TCRCChecksum expected = initial + current;
...
{
    TCRCChecksum expected = sut_.computed_crc(payloadified_, payloadified_.size);
    payloadified_ = sut_.append_crc_to_payload(payloadified_);

    TCRCChecksum actual = sut_.received_crc(payloadified_);
